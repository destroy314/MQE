...
class Go1Football1vs1Cfg(Go1Cfg):
    ...
    class terrain(Go1Cfg.terrain):
        ...
        BarrierTrack_kwargs = merge_dict(Go1Cfg.terrain.BarrierTrack_kwargs, dict(
            ...
            init = dict(
                block_length = 1.0,
                room_size = (0.0, 0.0),   # (0, 3.0) in Go1FootballDefenderCfg
                border_width = 0.00,
                offset = (0.5, 0),
            ),
            plane = dict(
...
class Go1FootballShootCfg(Go1Cfg):
    ...
    class terrain(Go1Cfg.terrain):
        ...
        BarrierTrack_kwargs = merge_dict(Go1Cfg.terrain.BarrierTrack_kwargs, dict(
            ...
            gate = dict(
                block_length = 1.0,
                width = 2.0,   # TODO: default 2.0
                depth = 1.0, # size along the forward axis  # TODO: default 1.0
                offset = (0, 0),
                random = (0, 0.),
            ),
            wall = dict(
